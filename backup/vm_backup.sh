#!/bin/bash
#
# vm_backup.sh - Script simplificado para backup de VMs
# Uso: sudo ./vm_backup.sh /caminho/para/config.yaml [nome_vm]
#
# Realiza backups completos offline de VMs conforme configuração
